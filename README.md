...
[Paper](https://arxiv.org/abs/2501.12202) · [PDF](https://arxiv.org/pdf/2501.12202) · [Issues](https://github.com/StaryMoon/Hunyuan3D-2-Unofficial/issues) · [Release](https://github.com/StaryMoon/Hunyuan3D-2-Unofficial/releases)
...
<p align="center">
  <img src="assets/paper-preview.png" alt="Hunyuan3D-2-Unofficial paper or project page preview" width="900">
</p>

<sub>Image source: public paper/project page screenshot, [Paper](https://arxiv.org/abs/2501.12202). Captured/organized on 2026-07-02. This repository is unofficial and is not affiliated with the paper authors.</sub>
...
| Venue / Source | 3D Generation / arXiv 2025 |
| Focus | This repository organizes a PyTorch implementation for Hunyuan3D 2.0: Scaling Diffusion Models for High Resolution Textured 3D Assets Generation, focusing on large-scale diffusi... |
...
This repository organizes a PyTorch implementation for **Hunyuan3D 2.0: Scaling Diffusion Models for High Resolution Textured 3D Assets Generation**, focusing on large-scale diffusion generation for high-resolution textured 3D assets. The codebase is structured like a standard research repository so that model components, configuration files, scripts, and evaluation utilities can be extended independently.
...
```bash
git clone https://github.com/StaryMoon/Hunyuan3D-2-Unofficial.git
cd Hunyuan3D-2-Unofficial
python -m venv .venv
...
```python
import torch
from hunyuan3d_2_unofficial import ModelConfig, UnofficialModel, reconstruction_loss

config = ModelConfig(task="3d", hidden_dim=128, num_layers=2, num_heads=4)
...
```python
import torch
from hunyuan3d_2_unofficial import UnofficialModel
...
|---|---|---|
| Main quantitative comparison | Main paper tables | [arXiv paper](https://arxiv.org/abs/2501.12202) |
| Ablation study | Experiment / ablation sections | [arXiv paper](https://arxiv.org/abs/2501.12202) |
| Qualitative examples | Main paper figures and appendix | [arXiv PDF](https://arxiv.org/pdf/2501.12202) |
...
```bibtex
@article{Hunyuan3D2_2025,
  title   = {Hunyuan3D 2.0: Scaling Diffusion Models for High Resolution Textured 3D Assets Generation},
  author  = {Zibo Zhao and Zeqiang Lai and Qingxiang Lin and Yunfei Zhao and Haolin Liu and Shuhui Yang and Yifei Feng and Mingxin Yang and others},
...
- Thanks to the authors of **Hunyuan3D 2.0: Scaling Diffusion Models for High Resolution Textured 3D Assets Generation** for the original research.
...
pytorch, unofficial-implementation, reproduction, hunyuan3d, 3d-generation, textured-3d-assets, diffusion-transformer
